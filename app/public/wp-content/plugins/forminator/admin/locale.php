...
"Starts with" => array( null, __("Starts with", "forminator" ), ), // src/form/components/behaviour/conditions-rule.js:231
"Ends with" => array( null, __("Ends with", "forminator" ), ), // src/form/components/behaviour/conditions-rule.js:234
...
"You can configure email notifications on the parent quiz as it is shared between this form and the parent quiz." => array( null, __("You can configure email notifications on the parent quiz as it is shared between this form and the parent quiz.", "forminator" ), ), // src/form/components/navigation/menu.js:96
"You can configure integrations on the parent quiz as it is shared between this form and the parent quiz." => array( null, __("You can configure integrations on the parent quiz as it is shared between this form and the parent quiz.", "forminator" ), ), // src/form/components/navigation/menu.js:117
"More settings options are coming soon" => array( null, __("More settings options are coming soon", "forminator" ), ), // src/form/components/navigation/menu.js:132
